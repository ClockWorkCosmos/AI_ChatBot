...
model = ChatBot(my_name, preprocessors=['chatterbot.preprocessors.clean_whitespace'], logic_adapters=[{'import_path': 'chatterbot.logic.MathematicalEvaluation'}, {"import_path": "chatterbot.logic.BestMatch", "statement_comparison_function": chatterbot.comparisons.LevenshteinDistance, "response_selection_method": chatterbot.response_selection.get_first_response}, {'import_path': 'chatterbot.logic.SpecificResponseAdapter', 'input_text': 'Help!', 'output_text': 'Ok, here is a link: http://chatterbot.rtfd.org'}, {"import_path": "chatterbot.logic.BestMatch", "statement_comparison_function": chatterbot.comparisons.LevenshteinDistance, "response_selection_method": chatterbot.response_selection.get_most_frequent_response}, {'import_path': 'chatterbot.logic.BestMatch', 'default_response': 'I am sorry, but I do not understand.', 'maximum_similarity_threshold': 0.66}], storage_adapter='chatterbot.storage.SQLStorageAdapter', database_uri='sqlite:///General_conversations_database.sqlite3')

trainer = ListTrainer(model)
corpus_trainer = chatterbot.trainers.ChatterBotCorpusTrainer

exit_conditions = ("Bye", "bye", "Goodbye", "goodbye", "Good bye", "good bye", "See you around", "see you around", "see you", "See you", "See you around!", "see you around!", "See you!", "see you!", "See ya", "see ya", "Later", "See you later", "see you later", "See you later!", "see you later!", "later", "Bye bye", "bye bye", "Taijian", "See you tomorrow!")
...
extreme_profanities_list = ["Nigga", "nigga", "Nigger", "nigger", "Faggot", "faggot", "Fag", "fag", "Gook", "gook", "Jap", "jap", "Beaner", "beaner", "Kraut", "kraut"]
...
timer_inquiries = ["Set a timer", "set a timer", "Can you set a timer for me?", "Set a timer for me", "Set a timer for", "set a timer for"]
time_set_flag = int(0)
...
def play_rock_paper_scissors():
        ...
        while True:
                ...
                if user_choice not in choices:
                        random_color_response(">> " + my_name + ": Invalid choice. Please choose from rock, paper, or scissors.")
                        talk("Invalid choice. Please choose from rock, paper, or scissors.")
                        continue
                ...
                if user_choice == cpu_choice:
                        ...
                        random_color_response("You win!")
                        talk("You win!")
                else:
                        random_color_response("You lose! Good game.")
                        talk("You lose! Good game.")
...
trainer.train(["Wanna play a game?", "Sure!", "Okay! Let's play Rock, Paper, Scissors. To play, try typing 'play rock paper scissors'."])
...
while True:
	...
	if query in exit_conditions:
		...
		if profanities_flag != 0:
			...
			if query == "play rock paper scissors":
